...
const envSchema = z.object({
    ...
    STRIPE_SUCCESS_URL: z.url().default('http://localhost:3000'),
    STRIPE_CANCEL_URL: z.url().default('http://localhost:3000'),
    ...
    EMAIL_FROM_ADDRESS: z.email().default('no-reply@afuhy.com.br'),
