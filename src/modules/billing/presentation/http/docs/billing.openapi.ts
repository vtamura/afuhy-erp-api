    ...
    schemas: {
        ...
        Plan: {
            ...
            properties: {
                ...
                name: { type: 'string', example: 'Afuhy ERP' },
                priceCents: { type: 'integer', example: 14990 },
                ...
                includedUsers: { type: 'integer', example: 5 },
        ...
        Subscription: {
            ...
            properties: {
                ...
                includedUsersSnapshot: { type: 'integer', example: 5 },
                additionalSeats: { type: 'integer', example: 2 },
                seatLimit: { type: 'integer', example: 7 },
                createdAt: { type: 'string', format: 'date-time' },
